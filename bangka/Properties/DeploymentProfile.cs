...
/// <summary>
/// Persisted build+deploy profile stored at ~/.aspimport/profiles/&lt;name&gt;.xml
/// Eliminates the need to retype flags on every build/deploy cycle.
/// CLI flags always override profile values when both are supplied.
/// </summary>
[XmlRoot("profile")]
public class DeploymentProfile
{
    ...
    public string ToEnvFileContent()
    {
        ...
        {
            $"# Generated by AspImport — profile: {Name}",
